...
- *PPP, qu'est-ce que c'est ? (l'acronyme de Petit Poulpe Perdu ?)* PPP est une unité de mesure pour définir la qualité d'une image, il signifie le nombre de Pixels Par Pouce. Plus ce chiffre est élevé, plus la qualité est élevée, et... plus le fichier est lourd ! 
...
Maintentant que nous disposons de Krita, nous allons 
